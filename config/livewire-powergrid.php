...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default PowerGrid translations.
    |
    */
    'translation' => [
        'actions' => 'Acciones',
        ...
        'default_export_filename' => 'exportacion',
        'column_is_hidden' => 'la columna está oculta',
        'reorder_by' => 'Reordenar por',
        'toggle_reorder' => 'Activar/desactivar reordenación',
        'soft_deletes' => 'Eliminados',
